...
export function getName(alpha2orAlpha3orNumeric: string | number, lang: string, nationalities?: boolean): string;
export function getNames(lang: string, nationalities?: boolean): LocalizedCountryNames;
...
export function getAlpha2Code(name: string, lang: string, nationalities?: boolean): string;
export function getAlpha3Code(name: string, lang: string, nationalities?: boolean): string;
